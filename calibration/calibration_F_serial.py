...
print(f"Applying Frequency Level: L")
send_haptic_signal([4])
input('Press ENTER to continue')
send_haptic_signal([0])
time.sleep(5)
print(f"Applying Frequency Level: M")
send_haptic_signal([8])
input('Press ENTER to continue')
send_haptic_signal([0])
time.sleep(5)
print(f"Applying Frequency Level: H")
send_haptic_signal([12])
input('Press ENTER to continue')
send_haptic_signal([0])
time.sleep(1)
...
signal_to_label = {4: 1, 8: 2, 12: 3}  # L=1, M=2, H=3
haptic_labels = [signal_to_label[s[0]] for s in haptic_signals]  # Convert list of lists
...
data = {
    ...
    "trial_order": [signal_to_label[s[0]] for s in haptic_signals],  # Convert to frequency levels
