...
def main(save_path, num):
	...
	while not shutdown:
		...
		A_pressed, B_pressed, X_pressed, Y_pressed, analogs, BACK_pressed = joystick.getInput()
		x_vel, y_vel, z_vel = analogs
		...
		xdot = [x_vel * joystick_gain, y_vel * joystick_gain, z_vel * joystick_gain, 0, 0, 0]
		qdot = Robot.xdot2qdot(xdot, states)
		Robot.send2robot(conn_robot, qdot, mode)
